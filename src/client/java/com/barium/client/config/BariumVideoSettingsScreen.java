...
public class BariumVideoSettingsScreen {
    ...
    public static Screen build(Screen parent) {
        ...
        ConfigBuilder builder = ConfigBuilder.create().setParentScreen(parent).setTitle(Text.translatable("title.barium.video_settings"));
        builder.setSavingRunnable(() -> { ConfigManager.saveConfig(); client.options.write(); });
        ...
        // CORREÇÃO: Corrigido o erro de digitação de "THROttling" para "THROTTLING"
