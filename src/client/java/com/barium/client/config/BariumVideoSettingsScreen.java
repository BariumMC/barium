...
// O import para a opção de partículas foi removido, pois estava causando erros de compilação.
...
public class BariumVideoSettingsScreen {
    ...
    public static Screen build(Screen parent) {
        ...
        // A OPÇÃO DE PARTÍCULAS FOI REMOVIDA TEMPORARIAMENTE PARA GARANTIR A COMPILAÇÃO.
