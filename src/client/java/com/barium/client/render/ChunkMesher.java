...
public class ChunkMesher {
    ...
    public Result mesh(BlockRenderView world, BlockPos sectionOrigin) {
        ...
        // Usar um VertexConsumerProvider funcional é a maneira mais limpa.
        ...
        for (int y = 0; y < 16; ++y) {
            for (int z = 0; z < 16; ++z) {
                for (int x = 0; x < 16; ++x) {
                    ...
                    // A CHAMADA CORRETA, ditada pelo compilador.
                    blockRenderManager.renderBlock(
                        ...
                        true, // cull
                        Collections.emptyList() // A List<BlockModelPart> exigida
                    );
